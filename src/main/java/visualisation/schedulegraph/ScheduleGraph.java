...
/**
 * This class takes in a specific data used to update the gantt chart on the scheduler
 * Base code taken from: https://stackoverflow.com/questions/27975898/gantt-chart-from-scratch
 */
public class ScheduleGraph<X,Y> extends XYChart<X,Y> {
    ...
    public static class ExtraData {
        ...
        public ExtraData(long lengthMs, String styleClass, String nameLabel) {
            super();
    ...
    public ScheduleGraph(@NamedArg("xAxis") Axis<X> xAxis, @NamedArg("yAxis") Axis<Y> yAxis) {
        this(xAxis, yAxis, FXCollections.<Series<X, Y>>observableArrayList());
    }

    public ScheduleGraph(@NamedArg("xAxis") Axis<X> xAxis, @NamedArg("yAxis") Axis<Y> yAxis, @NamedArg("data") ObservableList<Series<X,Y>> data) {
        super(xAxis, yAxis);
